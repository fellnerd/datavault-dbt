...
| Aufgabe | Detail | Status |
|---|---|---|
| RBAC Storage Blob Data Reader | MI-Zugriff auf Container `landing-zone`, `load-fs`, `stage-fs` | ⏳ EWB-Admin erforderlich |
...
| External Data Sources | PolyBase-Konfiguration auf `stage-fs` | 🔲 Offen (nach RBAC) |
...
| Tabelle | Staging-View | Status |
|---|---|---|
| FIBU.FHE | `stg.ewb_fibu_fhe_main` | ✅ Implementiert (Referenz-Modell) |
| FIBU.GL.E22 | `stg.ewb_fibu_gl_e22` | 🔲 Geplant |
| FIBU.GL.E23 | `stg.ewb_fibu_gl_e23` | 🔲 Geplant |
| FIBU.GL.E24 | `stg.ewb_fibu_gl_e24` | 🔲 Geplant |
| FIBU.GL.E25 | `stg.ewb_fibu_gl_e25` | 🔲 Geplant |
| FIBU.GL.E26 | `stg.ewb_fibu_gl_e26` | 🔲 Geplant |
| KRED.KBL | `stg.ewb_kred_kbl_main` | 🔲 Geplant |
| KRED.KVL | `stg.ewb_kred_kvl_main` | 🔲 Geplant |
| KRED.KBS | `stg.ewb_kred_kbs_main` | 🔲 Geplant |
| PROJ.NPO | `stg.ewb_proj_npo_main` | 🔲 Geplant |
| PROJ.NTC | `stg.ewb_proj_ntc_main` | 🔲 Geplant |
| PROJ.NTB | `stg.ewb_proj_ntb_main` | 🔲 Geplant |
| PROJ.NSA | `stg.ewb_proj_nsa_main` | 🔲 Geplant |
| PROJ.NTR | `stg.ewb_proj_ntr_main` | 🔲 Geplant |
| PROJ.PST | `stg.ewb_proj_pst_main` | 🔲 Geplant |
| PROJ.PRT | `stg.ewb_proj_prt_main` | 🔲 Geplant |
| LOHN.LEN | `stg.ewb_lohn_len_main` | 🔲 Geplant |
| LOHN.LTC | `stg.ewb_lohn_ltc_main` | 🔲 Geplant |
| PUBL.ADR | `stg.ewb_publ_adr_main` | 🔲 Geplant |
...
| `models/staging/sources.yml` | External Table `ext_ewb_fibu_fhe_main` konfiguriert | ✅ Erstellt |
...
*EWB Analytics Platform | PPMC AG | Stand: 9. März 2026*
