...
exports.ModelDetailsPanel = void 0;
...
class ModelDetailsPanel {
     ...
     */
    static createOrShow(extensionUri, model, metadata) {
        ...
        const panel = vscode.window.createWebviewPanel('datavaultModelDetails', `Model: ${model.name}`, column, {
            enableScripts: true,
     ...
     */
    getHtmlForWebview(model, metadata) {
...
<body>
  ...
  <script>
     ...
     */
    calculateLineage(model, metadata) {
...
exports.ModelDetailsPanel = ModelDetailsPanel;
