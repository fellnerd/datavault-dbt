  ...
  return (
    <div style={{ ...styles.container, ...(selected ? styles.containerSelected : {}) }}>
      ...
      <div style={styles.header}>
        <span style={styles.badge}>LNK</span>
      ...
      <div style={styles.body}>
        ...
        <div style={styles.row}>
          <span style={styles.label}>Link Hash Key (PK)</span>
        ...
        <div style={extraCols.length > 0 ? styles.row : styles.rowLast}>
          ...
          {foreignKeys.map((fk) => (
            <div key={fk} style={styles.fkRow}>
              <span style={styles.value}>{fk}</span>
            </div>
          ))}
        </div>
