...
description: "Vergleicht die neue Data Vault Implementierung mit den bestehenden Synapse structured-tables Views als Referenz. Stellt sicher, dass die DV-Implementierung die gleichen Ergebnisse liefert."
instructions: |
