...
description: "Erstellt vollständige EWB Staging-Views nach dem Adworks-Pattern. Workflow: Parquet-Schema → Type-Korrektur → sources.yml → Staging SQL → _staging__models.yml → Entity-Designer JSON → Design-Doku → Deploy."
instructions: |
